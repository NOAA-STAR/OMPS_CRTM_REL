...
MODULE ODPS_Define
  ...
  TYPE :: ODPS_type
    ...
    INTEGER(Long) :: nFOVs     = 0    ! Iuse
    INTEGER(Long) :: nCoeff     = 0    ! Iuse
    ...
    !  qliu
    ! using largest size 314600 from the first FOV
!    REAL(Single), Allocatable :: AllC(:,:)
!    INTEGER(Long), Allocatable :: Alln_Predictors(:,:,:) 
!    INTEGER(Long), Allocatable :: AllPos_Index(:,:,:)

    REAL(Single), POINTER :: AllC(:,:)  => NULL()  ! J x L
    INTEGER(Long), POINTER :: Alln_Predictors(:,:,:)  => NULL()  ! J x L
    INTEGER(Long), POINTER :: AllPos_Index(:,:,:)  => NULL()  ! J x L
